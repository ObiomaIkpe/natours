...
})({"f5m9s":[function(require,module,exports) {
...
const login = async (email, password)=>{
    ...
    try {
        ...
        (0, _alerts.showAlert)("failed", err.response.data.message);
    }
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["f5m9s","f2QDv"], "f2QDv", "parcelRequire11c7")
